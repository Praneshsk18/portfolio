    ...
    <div className="flex justify-center items-center pt-10">
      <div className="grid md:grid-cols-2 gap-20">
        {Skills.Projects.map((data, index) => (
          <div
            key={index}
            className="w-full h-full p-5 text-white bg-amber-600/10 border-2 border-transparent rounded-lg transform origin-center transition-all duration-500 ease-in-out hover:rotate-3 hover:border-orange-500 hover:shadow-lg flex flex-col"
          >
