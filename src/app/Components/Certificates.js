...
const Certificates = () => {
  return (
    <>
      <div className="grid lg:grid-cols-4 grid-cols-2 gap-5 lg:gap-10 justify-items-center pt-5 mx-5 lg:mx-32">
              ...
              >
                <div className="relative z-20 h-auto overflow-hidden rounded-[inherit] bg-amber-950/10 after:absolute after:inset-0 after:bg-linear-to-br after:from-gray-900/50 after:via-gray-800/25 after:to-gray-900/50">
                  ...
                  <Image
                    ...
                    alt="Workflow 01"
                  />
                  <div className="p-6 md:h-auto h-auto">
                    <div className="mb-3">
                      <span
                        className="btn-sm relative rounded-full px-2.5 py-0.5 text-xs font-normal 
