  ...
  const Contacts = () => {
    ...
    return (
      <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        {/* Page Title */}
        <motion.div initial={{scale:0}} whileInView={{scale:1}} className="text-center">
        ...
        <div className="mt-12 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Contact Form */}
          <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:0.5,delay:0.1}} className="bg-gray-600/30 p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold text-amber-500 mb-6">Send a Message</h2>
            <form onSubmit={additem}> {/* Attach additem to onSubmit */}
              <div className="mb-4">
          ...
          {/* Contact Details */}
          <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:0.5,delay:0.2}} className="bg-gray-600/30 p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold text-amber-500 mb-6">Contact Details</h2>
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-amber-700">Social Media</h3>
